...
def match_law(case_info):
    with open('reference/crime_mapping2.json') as f:
...
def get_penalty_instruction(case_info):
    with open('reference/punishment_mapping.json') as f:
...
def get_sentencing_factor_instruction(case_info):
    with open('reference/factors_mapping.json', encoding='utf-8') as factor_file:
